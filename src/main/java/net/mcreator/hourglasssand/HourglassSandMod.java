...
public class HourglassSandMod implements ModInitializer {
	public static final Logger LOGGER = LogManager.getLogger(HourglassSandMod.class);
	public static final String MODID = "hourglass_sand";

	@Override
	public void onInitialize() {
		// Start of user code block mod constructor
		// End of user code block mod constructor
		LOGGER.info("Initializing HourglassSandMod");
		HourglassSandModTabs.load();
